# Actividad 1- Análisis de Secuencias de Cancer de Pulmón
...
Realizando un análisis bioinformático de datos de RNA-Seq del adenocarcinoma de pulmón utilizando datos públicos de TCGA (The Cancer Genome Atlas), para identificar genes diferencialmente expresados entre tejido tumoral y normal, validando hallazgos reportados en la literatura científica
